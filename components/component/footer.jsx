...
export default function Footer() {
  return (
    <footer
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-10">
          ...
          <div className="lg:col-span-2 lg:ps-10">
            <h6
              ...
              <img alt="" src="https://i.imgur.com/crtpq5D.png" className="size-10 me-2 object-cover rounded-[40px] duration-300 bg-primary p-1"/>
              <div className="">
                <div className="">Morph</div>
                <div className="text-xs">Website and Digital Marketing</div>
              </div>
            </h6>
            <p>
          ...
          <div className="lg:col-span-2 lg:ps-10">
            ...
            <p className="mb-2">
              <Link href='/' className="te"
              >Home</Link>
            </p>
            <p className="mb-2">
              <Link href='/about' className="te"
              >About</Link>
            </p>
            <p className="mb-2">
              <Link href='/services' className="te"
              >Services</Link>
            </p>
            <p>
              <Link href='/blog' className="te"
              >Blogs</Link>
            </p>
          </div>
      ...
      {/* <!--Copyright section--> */}
      <div className="text-primary-foreground bg-primary p-4 text-center">
