    ...
    <>
      ...
      <div className="min-h-screen">
        <div className="grid max-w-7xl mx-auto min-h-screen items-center w-full py-20 lg:grid-cols-2">
          ...
          <div className="p-10">
            <div className="text-3xl lg:text-5xl font-semibold pb-2">Creative Digital Marketer</div>
            <div className="text-lg lg:text-left opacity-80 pb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa harum quos, temporibus amet, dolore iure fugiat deleniti provident non nihil, enim pariatur magnam. Quidem exercitationem provident itaque dicta necessitatibus a!</div>
            <div className="text-lg lg:text-left opacity-80 pb-5">Lorem ipsum dolor sit amet consectetur adporibus amet, dolore iure fugiat deleniti provident non nihil, enim pariatur magnam. Quidem exercitationem provident itaque dicta necessitatibus a!</div>
            <a href="" className="bg-primary rounded-lg px-3 py-2 text-primary-foreground">Let's talk</a>
          </div>
        </div>
      </div>
      <Features />
