      ...
      <div className="py-10 px-6">
        <div className="max-w-7xl mx-auto p-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 py-10 gap-8">
            <Bigger>
              <div className="p-5 border-2 border-primary rounded-lg text-primary flex flex-col gap-2 text-center justify-center items-center">
            ...
            <Bigger>
              <div className="p-5 border-2 border-primary rounded-lg text-primary flex flex-col gap-2 text-center justify-center items-center">
                ...
                <div className="text-2xl font-semibold">Twitter</div>
              </div>
            </Bigger>
            <Bigger>
              <div className="p-5 border-2 border-primary rounded-lg text-primary flex flex-col gap-2 text-center justify-center items-center">
